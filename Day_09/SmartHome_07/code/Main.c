...
//    }
    ...
    int mulu_fd = open("./you/mulu.bmp",O_RDWR);
    if(mulu_fd < 0)
    {
...
//
//    int pl_picture_fd = open("./plh_2.bmp",O_RDWR);
//    if(pl_picture_fd < 0)
//    {
...
//    }
//
//    Show_Bmp(tbg_fd,p,600,480,200,0);

//    Show_Num(67,p,381,376,0x00FF0000); //lxu
//    Show_Num(57,p,390,50,0x00FF0000);   //t
//    Show_Num(890,p,521,208,0x00FF0000); //h
//    Show_Num(999999,p,620,105,0x00FF0000);//p
//    Show_Num(23,p,707,362,0x00FF0000);//hum
