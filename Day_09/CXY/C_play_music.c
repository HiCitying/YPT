...
int main(void){
    ...
    show_bmp("/home/HIMA/Playmusic/music_background.bmp",600,480,200,0);
	show_bmp("/home/HIMA/Playmusic/last_music.bmp",100,100,350,280);
	show_bmp("/home/HIMA/Playmusic/music_start.bmp",100,100,450,280);
	show_bmp("/home/HIMA/Playmusic/next_music.bmp",100,100,550,280);
...
0x00,0x00,0x01,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
	...
	while(1){
		if(pid==0){
				...
				show_bmp("/home/HIMA/Playmusic/music_pause.bmp",100,100,450,280);
				//printf("PLAY\n");
				if(count==0){
					show_screen(350,0,250,50,0x00ffffff);
...
//上色
void draw_point(int x, int y, int color)//宽 高
{
