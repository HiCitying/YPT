...
void LTPHH(int *py,int *L,int *T,int *P,int *H1,int *H2)
{
    ...
    while(1)
    {
        ...
        *H2=h;
        ...
        ClearScreen(py,0,280,100,100,0x00ffffff);
        Show_Num(*L,py,300,0,0x00FF0000);
        Show_Num(*T,py,300,20,0x00FF0000);
        Show_Num(*P,py,300,40,0x00FF0000);
        Show_Num(*H1,py,300,60,0x00FF0000);
        Show_Num(*H2,py,300,80,0x00FF0000);
        sleep(1);
